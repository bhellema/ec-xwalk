...
// URL and local HTML file
const url = 'https://www.themeateater.com/about-us';
const htmlFilePath = path.join(__dirname, '../../migration-work/cleaned.html');

console.log(`Reading local HTML file: ${htmlFilePath}`);
...
results.forEach(result => {
  ...
  fs.writeFileSync(outputPath, result.element.innerHTML);
